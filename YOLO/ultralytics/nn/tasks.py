...
from ultralytics.nn.modules.SimAM import SimAM, C3_SimAM, C2f_SimAM_KAN, KANLayer, KANBottleneckWithSimAM

from .modules.MobileNetV4 import MobileNetV4ConvLarge,MobileNetV4ConvSmall, \
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, C3_SimAM, C2f_SimAM_KAN, KANLayer, KANBottleneckWithSimAM}:
