...
if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'E:\gaijin\shiyan\ultralytics-8.2.72\ultralytics-8.2.72\runs\detect\train\weights\best.pt')
    # 验证模型
    metrics=model.val(
        val=True,  # (bool) 在训练期间进行验证/测试
        data=r'E:/gaijin/shiyan/ultralytics-8.2.72/ultralytics-8.2.72/ultralytics/cfg/datasets/hat.yaml', #这里写自己数据集 yaml 文件的路径
